      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <nav className="flex flex-wrap items-center gap-x-5 gap-y-2 text-sm text-neutral-500">
            <Link href="/opportunities" className="hover:text-neutral-900 transition">Jobs</Link>
            <Link href="/freight" className="hover:text-neutral-900 transition">Freight</Link>
            <Link href="/opportunities" className="hover:text-neutral-900 transition">Opportunities</Link>
        ...
        <div className="mt-6 pt-4 border-t border-neutral-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          <p className="text-xs text-neutral-400">
            &copy; 2026 Outback Connections. Built for rural Australia.
          </p>
